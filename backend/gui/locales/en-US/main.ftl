...
add-card-examples-label = Examples (Optional):
add-card-example-sentence-placeholder = Example sentence
add-card-example-translation-placeholder = Example translation
add-card-add-example = Add Example
...
learn-definition-label = Definition
learn-translated-definition-label = Translated definition
learn-translations-label = Translations
learn-examples-label = Examples:
learn-show-examples = Show examples
learn-hide-examples = Hide examples
