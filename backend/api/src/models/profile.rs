...
mod tests {
    ...
    fn test_profile_dto_creation() {
        ...
        assert_eq!(dto.profile_name, "My Spanish");
    ...
    fn test_profile_dto_clone() {
        let dto = ProfileDto {
            profile_name: "My French".to_string(),
    ...
    fn test_profile_dto_serialization() {
        let dto = ProfileDto {
            profile_name: "My German".to_string(),
            target_language: "german".to_string(),
            created_at: 5000,
            last_activity: 6000,
        };
        let json = serde_json::to_string(&dto).unwrap();
        assert!(json.contains("My German"));
    ...
    fn test_profile_dto_deserialization() {
        let json = r#"{
            "profile_name": "My Italian",
            "target_language": "italian",
            "created_at": 7000,
            "last_activity": 8000
        }"#;
        let dto: ProfileDto = serde_json::from_str(json).unwrap();
        assert_eq!(dto.profile_name, "My Italian");
